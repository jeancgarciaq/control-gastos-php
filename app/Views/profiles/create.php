...
<!-- Contenido específico del Profiles Create -->
        ...
        <form method="post" action="/profiles/create">
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                       id="name" type="text" name="name" placeholder="Name" value="<?= htmlspecialchars($data['name'] ?? '') ?>">
            </div>
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                       id="phone" type="text" name="phone" placeholder="Phone" value="<?= htmlspecialchars($data['phone'] ?? '') ?>">
            </div>
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                       id="position_or_company" type="text" name="position_or_company" placeholder="Position or Company" value="<?= htmlspecialchars($data['position_or_company'] ?? '') ?>">
            </div>
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                       id="marital_status" type="text" name="marital_status" placeholder="Marital Status" value="<?= htmlspecialchars($data['marital_status'] ?? '') ?>">
            </div>
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                       id="children" type="number" name="children" placeholder="Children" value="<?= htmlspecialchars($data['children'] ?? '') ?>">
            </div>
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                       id="assets" type="number" step="0.01" name="assets" placeholder="Assets" value="<?= htmlspecialchars($data['assets'] ?? '') ?>">
            </div>
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                       id="initial_balance" type="number" step="0.01" name="initial_balance" placeholder="Initial Balance" value="<?= htmlspecialchars($data['initial_balance'] ?? '') ?>">
            </div>
